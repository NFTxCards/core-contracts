...
describe("Verifier contract", function () {
    ...
    describe("verify", () => {
        ...
        it("should be failed: signed transaction expired", async function () {
            ...
            await expect(
                verifier.verify(v, r, s, sender.address, params.message.deadline),
        ...
        it("should be failed: verify invalid signature", async function () {
            ...
            await expect(
                verifier.verify(v, r, s, badSender.address, params.message.deadline),
            ).to.be.revertedWith("verify invalid signature");
        });
    });
});
